# Robs's Hassio Add-ons: Headphones

## About

Headphones add-on based on the prebuilt docker image from linuxserver
Headphones - A fork of Sonarr to work with movies à la Couchpotato.
